...
// 既存V4〜V10は削除不要
// GRADE UPは別DOMを作らず
// 既存.v10Ascensionそのものを書き換える
// =====================================================

(() => {

  if(window.__PREMIUM_DROP_MASTER_V11__) return;
  window.__PREMIUM_DROP_MASTER_V11__ = true;
    ...
    .crtPuchunScreen::before{
      ...
      background:
        linear-gradient(
          ...
          rgba(180,230,255,.12) 12%,

          rgba(225,248,255,.70) 28%,

          #ffffff 46%,

          #ffffff 54%,

          rgba(195,235,255,.74) 72%,

          rgba(120,205,255,.10) 88%,
    ...
    .crtPuchunScreen::after{
      ...
      background:
        ...
        radial-gradient(
          circle,
          #ffffff 0%,
          rgba(225,248,255,.95) 12%,
          rgba(155,215,255,.48) 34%,
          transparent 70%
        )
        !important;
  ...
  function upgradeDropResult(){
    ...
    const rarity =
      ...
      ["NORMAL","RARE","EPIC","LEGEND","GOD"]
      .find(r=>
        card.classList.contains(r)
      );
